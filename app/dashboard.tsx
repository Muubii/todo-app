...
const styles = StyleSheet.create({
  ...
  header: { position: "absolute", top: 20, right: 20 },
  profileIcon: { alignSelf: "flex-end" },
  dropdown: { position: "absolute", top: 50, right: 0, backgroundColor: "#fff", borderRadius: 8, padding: 10, shadowColor: "#000", shadowOpacity: 0.1, shadowRadius: 4, elevation: 3, width: 120 },
  dropdownItem: { fontSize: 16, paddingVertical: 8, paddingHorizontal: 10 },
  title: { fontSize: 24, fontWeight: "bold", marginTop: 60, marginBottom: 20, textAlign: "center" },
  contentWrapper: { width: "100%", maxWidth: 500, backgroundColor: "#fff", padding: 20, borderRadius: 12, shadowColor: "#000", shadowOpacity: 0.1, shadowRadius: 4, elevation: 3 },
  input: { width: "100%", height: 45, borderWidth: 1, borderColor: "#ccc", borderRadius: 8, paddingHorizontal: 10, backgroundColor: "#fff", marginBottom: 10 },
  textArea: { height: 100, textAlignVertical: "top" },
  button: { backgroundColor: "#007BFF", paddingVertical: 12, borderRadius: 8, alignItems: "center", marginBottom: 20 },
  buttonText: { color: "#fff", fontSize: 16, fontWeight: "bold" },
  noteItem: { backgroundColor: "#fff", padding: 15, borderRadius: 8, marginBottom: 10, flexDirection: "row", justifyContent: "space-between", alignItems: "center", shadowColor: "#000", shadowOpacity: 0.1, shadowRadius: 4, elevation: 2 },
